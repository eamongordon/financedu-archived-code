...
import { generateAdminInvite } from 'backend/memberFunctions/classInvites.jsw';
...
export function inviteStudentButton_click(event) {
    ...
    if ($w('#emailInput').valid) {
        ...
        generateAdminInvite(email, received.classId).then(() => {
...
export function inviteMultipleStudentsButton_click(event) {
    ...
    emailArray.forEach((email) => {
        promises.push(generateAdminInvite(email, received.classId));
    })
